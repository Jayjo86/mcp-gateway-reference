"""Entra token validation for mcp-server-b."""
...
def build_auth() -> RemoteAuthProvider:
    ...
    audience = _require_env("MCP_SERVER_B_AUDIENCE")
    app_id = _require_env("MCP_SERVER_B_APP_ID")
    ...
    verifier = JWTVerifier(
        ...
        # (api://mcp-server-b) it yields "mcp-server-b" and every M2M call is
        # rejected.
    ...
    return RemoteAuthProvider(
        ...
        resource_name="mcp-server-b (fake ledger)",
    )
